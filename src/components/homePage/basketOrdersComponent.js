...
function BasketOrdersComponent(props) {
    ...
    return (
        <div className="shoppingCard1">
            <AddressModalForm modalForm={modalForm} setModalForm={setModalForm} setAddressList={setAddressList}
                              setDefaultAddress={setDefaultAddress}/>
            <AddressListModal modalList={modalList} setDefaultAddress={setDefaultAddress} setModalList={setModalList}
                                ...
                                <div className="shoppingCardAddress">
                                    ...
                                    <div className="shoppingCardAddressMain d-flex justify-content-between">
                                        ...
                                        <div className="shoppingCardAddressMainRight">
                                            <div className="newAddress" onClick={() => setModalForm(true)}>
                                                + Yangi manzil qoshish
                                            </div>
                                            <div className="switchAddress" onClick={() => setModalList(true)}>
                                    ...
                                    return <div className="shoppingCardItem1">
                                        ...
                                        <div className="shoppingCardItemMain1">
                                            ...
                                            <div className="shoppingCardItemMainCenter1">
                                                <Link to="/" className="shoppingProductLink">
                                                ...
                                                <div className="detail">
                                                    <span>{item.detail_uz}:</span> {item.value_uz}
                                                </div>
                    ...
                    <div className="col-md-3">
                        <div className="shoppingCardRight1">
                            ...
                            <Link className="totalPurchaseButton">
                                <button>Sotib olish ({JSON.parse(localStorage.getItem('shoppingCardList')).length})
                                </button>
                            </Link>
                        </div>
                    </div>
