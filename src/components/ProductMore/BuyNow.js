...
const BuyNow = (props) => {
    ...
    useEffect(()=>{
        ...
        //         return index === address.length-1 ? setaddres(item) : ""
        //     })
        // }
        //
        // console.log(addres)
...

                                    {
                                        open1 ? <div className="addresfor">
                                            <div className="addresform1">
                                                <div className="addresform1_1">
                                                    <div className="addresform2">
                                                        <AddAddress setAddress1={setAddress1} setOpen1={setOpen1} address={address} setAddress={setAddress} addres={addres} setaddres={setaddres}/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> : ""
